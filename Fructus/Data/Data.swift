...
Comp(title: "NYTC",
      ...
      description: 
"""
We had 2 different types of challenges.
Number 1: We had to pilot a trello drone through an obstacle course without crashing.
Number 2: We had to programm a drone to carry out a certain function. Out of 52 teams, we qualified to the semi-finals - top 20 teams!
""",
...
Comp(title: "Ngee ann poly",
      ...
      description: 
"""
We have learnt how to use salesforce and use its lightning components, we have even used Apex. After training, we have a compeition to test out our new abilities. We have won quite a few of them
""",
...
Comp(title: "Meta bootcamp",
      ...
      description: 
"""
We learnt how to create augmented reality and face filters. We even one of the prizes! Using met spark studio we created our very own filters and vritual objects
""",
...
Comp(title: "SwiftUI",
      ...
      description: 
"""
SwiftUI, We have learnt how to code Swift, the language apple uses to code some of their very own apps! We have learnt about functions, structs, classes, variables and a lot more. 
Fun Fact: This App is coded using Swift
""",
...
Comp(title: "Apple new media course",
      ...
      description: 
"""
We learnt about Augmented reality and used applications such as jigspace, and more! We learnt about making presentations and a bit on marketing. 
How we can fully sell our ideas to our customers to the best of our abilities.
""",
      details: ["Full Year Course", "Once a week", "2 Hours"]
      ), // DO NOT CHANGE
...
Comp(title: "JP Morgan",
     ...
     gradientColors: [Color("ColorBlueberryLight"), .white],
      description: 
"""
We was split into different groups working with different people from different schools and creating an app that can be used for the reality of what’s happening in the 
world such as hunger, gender equality, education needs. Basically to solve real life issues.
""",
